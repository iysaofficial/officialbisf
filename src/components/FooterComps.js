			...
			<div className="container">
					...
					<div className="col-md-4 col-lg-5">
						<div className="row">
							<div className="img-footer col-md-12 col-lg-8 mb-md-0 mb-4">
								...
								<img src="./assets/images/logo/LOGO BISF.png" alt="" className="img-fluid"/>
						...
						<div className="row">
							<div className="col-md-4 mb-md-0 mb-4 border-left">
								...
								<ul className="list-unstyled">
                                    ...
                                    <li><a href="https://www.iysaolympiad.or.id/" target="_blank" className="py-1 d-block fw-bold"><i className="fa fa-house me-1"></i>Our Main Website</a></li>
                                </ul>
							</div>
							<div className="col-md-4 mb-md-0 mb-4 border-left">
				...
				<div className="row mt-5">
                    <div className="col-md-6 col-lg-8 mx-auto">
                        <p className="copyright text-center fw-bold">Copyright BISF OFFICIAL All rights reserved </p>
                    </div>
                </div>
			</div>
		</footer>
